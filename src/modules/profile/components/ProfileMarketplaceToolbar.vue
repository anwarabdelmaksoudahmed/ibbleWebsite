...
<template>
  <div
    ...
    role="search"
    :aria-label="t('site.profile.marketplace.filters.label')"
  >
    <BaseSearchInput
      :model-value="search"
      :placeholder="t('site.profile.marketplace.filters.searchPlaceholder')"
      :aria-label="t('site.profile.marketplace.filters.searchPlaceholder')"
      :disabled="disabled"
      size="sm"
    ...
    <BaseSelect
      ...
      :placeholder="t('site.profile.marketplace.filters.status')"
      :disabled="disabled"
      size="sm"
      root-class="!space-y-0"
