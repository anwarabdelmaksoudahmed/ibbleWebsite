...
<template>
  <div
    ...
    role="search"
    :aria-label="t('site.profile.transportation.filters.label')"
  >
    <BaseSearchInput
      :model-value="search"
      :placeholder="t('site.profile.transportation.filters.searchPlaceholder')"
      :aria-label="t('site.profile.transportation.filters.searchPlaceholder')"
      :disabled="disabled"
      size="sm"
    ...
    <BaseSelect
      ...
      :placeholder="t('site.profile.transportation.filters.status')"
      :disabled="disabled"
      size="sm"
      root-class="!space-y-0"
